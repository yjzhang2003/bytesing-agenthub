...
.agenthub-home-nav-actions {
  display: inline-flex;
  align-items: center;
  justify-content: flex-end;
  gap: 8px;
}
.agenthub-home-github-link {
  min-height: 28px;
  display: inline-flex;
  align-items: center;
  gap: 6px;
...
.agenthub-home-github-link:hover,
.agenthub-home-github-link:focus-visible {
  color: var(--agenthub-text);
  border-color: var(--agenthub-border-strong);
  background: var(--agenthub-surface);
}
...
@media (max-width: 760px) {
  ...
  .agenthub-home-brand > span:not(.agenthub-home-mark) {
    display: none;
  }
  .agenthub-home-nav-links {
    display: none;
...
.agenthub-workbench-loading-screen {
  position: relative;
  min-height: 100vh;
  display: grid;
  place-items: center;
...
.agenthub-loading-orbit-ring {
  position: absolute;
  inset: 0;
  border: 1px solid color-mix(in srgb, var(--agenthub-accent) 36%, transparent);
  border-radius: inherit;
  animation: agenthub-loading-orbit 1400ms linear infinite;
}
.agenthub-loading-orbit-ring:nth-child(2) {
  inset: 13px;
  border-color: color-mix(in srgb, var(--agenthub-status) 42%, transparent);
  animation-duration: 1900ms;
  animation-direction: reverse;
}
.agenthub-loading-orbit-ring::before {
  content: "";
  position: absolute;
  top: -4px;
  left: 50%;
  ...
  border-radius: 999px;
  background: var(--agenthub-accent);
  box-shadow: 0 0 20px color-mix(in srgb, var(--agenthub-accent) 60%, transparent);
}
.agenthub-loading-orbit-ring:nth-child(2)::before {
...
.agenthub-workbench-loading-copy strong {
  font-size: 17px;
  line-height: 1.25;
}
.agenthub-workbench-loading-copy p {
  max-width: 340px;
  margin: 0;
  color: var(--agenthub-text-muted);
}
...
@keyframes agenthub-loading-orbit {
  to { transform: rotate(360deg); }
}
@keyframes agenthub-loading-core {
  0%, 100% { opacity: .82; transform: scale(.92); }
  50% { opacity: 1; transform: scale(1.08); }
}
@keyframes agenthub-workbench-loading-drift {
  from { transform: translate3d(0, 0, 0); }
  to { transform: translate3d(54px, 54px, 0); }
}
@keyframes agenthub-workbench-loading-sheen {
...
.agenthub-chat-add-agent-copy small {
  min-width: 0;
  color: var(--agenthub-text-muted);
  overflow: hidden;
  text-overflow: ellipsis;
...
.agenthub-new-conversation-modal .agenthub-dialog-body {
  max-height: min(72vh, 620px);
  overflow: hidden;
}
.agenthub-new-conversation-modal .agenthub-modal-confirm-button:not(:disabled) {
  border-color: var(--agenthub-accent);
  background: var(--agenthub-accent);
  color: var(--agenthub-accent-text);
}
.agenthub-new-conversation-dialog {
  min-width: 0;
  display: grid;
  gap: 12px;
}
.agenthub-new-conversation-dialog .agenthub-chat-add-agent-list,
.agenthub-project-picker {
...
.agenthub-project-option:hover,
.agenthub-project-option:focus-visible,
.agenthub-project-option[data-selected="true"] {
  border-color: var(--agenthub-border-strong);
  background: var(--agenthub-surface-hover);
  outline: 0;
}
...
.agenthub-project-option-main,
.agenthub-project-option-meta {
  min-width: 0;
  display: grid;
  gap: 2px;
}
.agenthub-project-option-main strong,
.agenthub-project-option-main small,
.agenthub-project-option-meta small {
  min-width: 0;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
.agenthub-project-option-main strong {
  font-size: var(--agenthub-type-lg);
  font-weight: 720;
}
.agenthub-project-option-meta {
  justify-items: end;
...
.agenthub-project-create-button {
  ...
  min-height: 38px;
  gap: 8px;
  border-color: var(--agenthub-text) !important;
  background: var(--agenthub-text) !important;
  color: var(--agenthub-bg) !important;
  font-weight: 680;
  padding-inline: 12px;
  white-space: normal;
}
.agenthub-project-create-button .agenthub-icon {
  flex: 0 0 auto;
  display: block;
}
.agenthub-project-create-button:not(:disabled):hover,
.agenthub-project-create-button:not(:disabled):focus-visible {
  border-color: var(--agenthub-text-muted) !important;
  background: var(--agenthub-text-muted) !important;
  color: var(--agenthub-bg) !important;
}
.agenthub-file-list {
  display: grid;
