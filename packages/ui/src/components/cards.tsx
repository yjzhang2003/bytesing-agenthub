import type { DiffFileSummary, PermissionRisk, PermissionStatus, PlanStatus } from "@agenthub/contracts";
  ...
  return (
    <article aria-label={`Plan ${props.status}`} className="agenthub-card agenthub-plan-card">
      ...
      <footer>
        ...
        <HoverButton type="button">Revise</HoverButton>
        <HoverButton type="button">Cancel</HoverButton>
      </footer>
    </article>
  );
}
...
export function DiffCard(props: {
  ...
  return (
    <article aria-label={`Diff ${props.state}`} className="agenthub-card agenthub-diff-card">
      ...
      <HoverButton type="button">Open review</HoverButton>
    </article>
  );
}
